...
function OffertPlaceholder() {
	return (
		<div className="offert-placeholder">
			...
			<Body1 block>Offertflödet med AI-bedömning kommer snart. Du kan redan nu kontakta oss via mejl eller telefon för en offert.</Body1>
			<Link to="/">
				<Button
