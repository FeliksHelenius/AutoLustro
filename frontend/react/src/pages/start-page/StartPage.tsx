...
import {Button, Link as FluentLink, Title3, Body1, Caption1, mergeClasses} from "@fluentui/react-components";
import {VehicleCarRegular, DocumentTextRegular, ShieldCheckmarkRegular, SparkleRegular} from "@fluentui/react-icons";
		...
		<div className={c.startPage}>
			<header className={c.startHeader}>
				<div className={c.startHeaderInner}>
					<Link
						to="/"
						aria-label="AutoLustro startsida"
						className={c.startBrandBlock}
					>
						<img
							src={smallLogoUrl}
							alt=""
							className={c.startLogo}
						/>
			...
			<section className={mergeClasses(c.startHero, c.startHeroVideoWrap)}>
				...
				<div className={mergeClasses(c.startHeroInner, c.startHeroContent)}>
					...
					<img
						src={fullLogoUrl}
						alt="AutoLustro – Bilvård & Rekond"
						className={c.startHeroLogo}
					/>
					<p className={c.startHeroDesc}>
						Ett familjeföretag inom bilrekond med över 20 års erfarenhet. Vi tar hand om hela bilens yttre och inre – från vardaglig tvätt till
						avancerad rekond som återställer djup glans och ett fräscht intryck.
					</p>
					<p className={c.startHeroMethods}>
						Beprövade metoder och förstaklassiga, miljövänliga medel. När det krävs använder vi oscillerande och roterande teknik inklusive
						kontrollerad värme med polertrissan för att effektivt reducera repor och ge lacken maximal klarhet.
					</p>
					<Link to="/offert">
						<Button
							appearance="primary"
			...
			<section
				id="tjanster"
				className={c.startSection}
			>
				<div className={c.startSectionInner}>
					<Title3
						as="h2"
						className={c.startSectionTitle}
					>
			...
			>
				<div className={c.startSectionInner}>
					...
					<Body1
						as="p"
						className={c.startProtectionIntro}
					>
						Vi erbjuder både traditionellt vax och mer långvarig försegling:
					</Body1>
					<ul className={c.startProtectionList}>
						<li className={c.startProtectionListItem}>
							<strong>Vax</strong> – hållbarhet cirka 3–6 månader
						</li>
						<li className={c.startProtectionListItem}>
							<strong>Lackskydd/försegling</strong> – hållbarhet cirka 12–18 månader
						</li>
					</ul>
					<Caption1
						as="p"
						className={c.startProtectionNote}
					>
				...
				<div className={c.startFooterInner}>
					<div className={c.startFooterBrandBlock}>
						<img
							src={smallLogoUrl}
							alt=""
							className={c.startFooterLogo}
						/>
						<span className={c.startFooterLogoText}>AutoLustro</span>
					</div>
					<Caption1
						as="p"
						className={c.startFooterLegal}
					>
